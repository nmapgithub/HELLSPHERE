...
def main():
    ...
    parser.add_argument("--serpapi-key", type=str, help="SerpAPI Google Search API key")
    parser.add_argument("--public-ip", type=str, default="localhost", help="Public IP address for HTTP server access")
    parser.add_argument("--http-port", type=int, default=2001, help="HTTP server port for image access")
    args = parser.parse_args()

    if args.image:
        # Initialize GeoIntel with optional API key
        geointel = GeoIntel(api_key=args.api_key)
        serpapi_key = args.serpapi_key or "ffdc1a91340395fc2b40cc14735e27e5d226474da8c1f7f50c00d181522b377d"
